...
public class RegistrationResource {
    ...
    public List<RegistrationSummary> registrationsForEvent(@PathParam("externalConferenceId") Long externalConferenceId) {
        List<Registration> registrations = Registration.find("conference.externalId", externalConferenceId)
                                                       .list();
        ResourceUtils.exceptionIfEmpty(registrations,
                                       "No registration found for conference",
                                       Status.NOT_FOUND);
